    ...
    >
      <NoneBorder>
        <Row gutter={[16, 16]}>
          ...
          <Col span={8}>{donThu?.HanGiaiQuyetFrist_Str}</Col>
          {/*  */}
          <Col span={4}>
            <strong>Trạng thái:</strong>
          </Col>
        ...
        <>
          <NoneBorder>
            <Row gutter={[16, 16]}>
              ...
              <Col span={18}>{donThu?.TenLoaiKhieuTo}</Col>
              {/*  */}
              <Col span={4}>
            ...
            <Row gutter={[16, 16]}>
              ...
              <Col span={8}>{donThu?.NgayGiao}</Col>
              {/*  */}
              <Col span={4}>
              ...
              <Col span={8}>{donThu?.HanGiaiQuyetFrist}</Col>
              {/*  */}
              <Col span={4}>
                <strong>Trạng thái:</strong>
              </Col>
              <Col span={8}>{donThu?.TrangThaiDongBo}</Col>
              {/*  */}
              <Col span={24}>
              ...
              <Col span={8}>{donThu?.KetQuaGiaiQuyet}</Col>
              <Col span={4}>
